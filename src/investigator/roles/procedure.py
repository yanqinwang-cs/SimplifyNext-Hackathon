...
INVESTIGATOR_PROCEDURE = (
    ...
    ProcedureSpec("move_focus", "Move within the active local reasoning region.", "The destination is a legal active local graph node.", "Keeps Investigator authority local.", "Directly changing global focus.", "request_steward_review.", "investigator"),
...
STEWARD_PROCEDURE = (
    ...
    ProcedureSpec("shift_focus", "Move global attention to a materially better active region.", "A valid active destination is identified and globally more useful.", "Manages global attention outside Investigator locality.", "Investigator directly changing global focus.", "request_steward_review.", "steward"),
