...
class Stage1Fixture:
    def __init__(self, fixture_id, description, graph, focus, available_enquiries, releases, properties, materially_usable_action_ids=None):
