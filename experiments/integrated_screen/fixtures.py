...
class Stage1Fixture:
    def __init__(self, fixture_id, description, graph, focus, available_enquiries, releases, properties):
        self.fixture_id, self.description, self.graph, self.focus = fixture_id, description, graph, focus
        self.available_enquiries, self.releases, self.properties = available_enquiries, releases, properties
