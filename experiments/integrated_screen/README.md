...
Each Investigator or Steward turn permits one bounded retry for invalid structured output; both attempts are recorded. A trusted, exhausted Steward terminates with `HANDOFF_TO_HUMAN`, recording important unresolved uncertainties in the handoff (possibly none). This is a neutral workflow handoff; final human judgment remains required.
