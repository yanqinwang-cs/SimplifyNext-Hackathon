...
def all_scenarios() -> list[StewardScenario]:
    ...
    return [
        ...
        _scenario("T1", "Only active unresolved U1 remains and the trusted frontier review is structurally exhausted.", {"H1": _node("H1", n.HYPOTHESIS, "Open explanation."), "U1": _node("U1", n.UNCERTAINTY, "Unresolved question.")}, [_edge("U1", EdgeRelation.TARGETS, "H1")], "H1", "handoff_to_human", context=_context(), stopped=True),
