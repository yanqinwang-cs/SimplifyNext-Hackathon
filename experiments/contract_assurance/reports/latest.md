...
- Generated: 2026-09-01T02:23:30.689094+00:00
- Contracts: 8

| Metric | Count |
| --- | ---: |
| Total evaluations | 473 |
| Accepted | 34 |
| Rejected | 439 |
...
- Observed deterministic failure rate: `0.9281`; upper 95% bound: `0.9481` (compliance statistic, not reasoning confidence).
...
| `StewardDecisionResponse` / `adversary` | 1 | 1 | 0 | 1 | 0 | 1 |
| `StewardDecisionResponse` / `producer` | 1 | 1 | 0 | 1 | 1 | 0 |

| Blind role | Batches | Qualified evaluations | Accepted | Rejected |
| --- | ---: | ---: | ---: | ---: |
| `adversary` | 14 | 9 | 0 | 9 |
| `producer` | 13 | 9 | 9 | 0 |
- Qualified blind failure codes: `{'S0': 1, 'S1': 2, 'S3': 3, 'S4': 3}`
- Qualified blind output metrics: placeholder copies `1`, fenced outputs `0`, average length `326.3` characters.
...
| `StewardDecisionResponse` | 42 | 13 | 29 | 1.0000 | 1.0000 | 16 | 13 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
