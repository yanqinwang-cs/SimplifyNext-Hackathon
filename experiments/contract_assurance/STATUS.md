...
- Last checkpoint: `2466506` (`Refresh reports with blind failure distributions`); current cycle adds deterministic valid-pass and invalid-rejection metrics to JSON/Markdown reports.
