...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 406 cases: 21 accepted, 385 rejected, 0 unexpected outcomes. Focused assurance suite: 46 passed; full repository suite: 139 passed.
...
- Last checkpoint: `3a278b6` (`Expand nested expansion namespace coverage`); current cycle adds competing-root branch-pollution coverage.
