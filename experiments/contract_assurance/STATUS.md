...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 399 cases: 21 accepted, 378 rejected, 0 unexpected outcomes. Focused assurance suite: 44 passed; full repository suite: 137 passed.
...
- Last checkpoint: `cbf4569` (`Harden model screen hypothesis text`); current cycle adds offline SmokeResponse substantive-answer coverage.
