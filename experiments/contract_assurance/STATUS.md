...
- Last checkpoint: `24d55c5` (`Refresh reports after package coverage gate`); current cycle adds deterministic failure-rate statistics to JSON/Markdown reports.
