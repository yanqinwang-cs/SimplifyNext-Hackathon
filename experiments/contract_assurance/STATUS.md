...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 405 cases: 21 accepted, 384 rejected, 0 unexpected outcomes. Focused assurance suite: 46 passed; full repository suite: 139 passed.
...
- Last checkpoint: `4d035e9` (`Cover empty conclusion reasons`); current cycle adds nested expansion evidence-namespace coverage.
