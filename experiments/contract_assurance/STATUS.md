...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 292 cases: 21 accepted, 271 rejected, 0 unexpected outcomes. Full repository suite: 130 passed.
...
- Last checkpoint commit: `4af34c7` (`Expand identifier format mutation coverage`)
