...
- Last checkpoint: `efa6bf0` (`Reject nested operation reason placeholders`); current cycle strengthens recursive prompt/schema/template lint and repairs the expansion public example.
