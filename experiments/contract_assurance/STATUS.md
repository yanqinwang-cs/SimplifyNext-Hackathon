...
- Last checkpoint: `79a10e4` (`Refresh assurance reports after lint checkpoint`); current cycle closes missing/extra blind-package adapter verification.
