...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 360 cases: 21 accepted, 339 rejected, 0 unexpected outcomes. Full repository suite: 130 passed.
...
- Last checkpoint commit: `aa57b35` (`Harden specialization relationship invariants`)
