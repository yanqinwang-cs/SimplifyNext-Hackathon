...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 279 cases: 21 accepted, 258 rejected, 0 unexpected outcomes. Full repository suite: 129 passed.
...
- Last checkpoint commit: `fefcce5` (`Expand referential evidence coverage`)
