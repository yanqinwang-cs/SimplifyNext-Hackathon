...
- Coverage gaps: deeper contract-specific S2/S4 mutation families and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 151 cases: 15 accepted, 136 rejected, 0 unexpected outcomes. Full repository suite: 127 passed.
...
- Last checkpoint commit: `1a907c6` (`Add contract assurance command entrypoint`)
