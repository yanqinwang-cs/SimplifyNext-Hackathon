...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 380 cases: 21 accepted, 359 rejected, 0 unexpected outcomes. Focused assurance suite: 38 passed; full repository suite: 131 passed.
...
- Last checkpoint commit: `b4f4c59` (`Expand nested evidence namespace coverage`)
