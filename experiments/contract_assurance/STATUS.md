...
- Coverage gaps: deeper contract-specific S2/S4 mutation combinations and genuinely isolated blind workers; `SmokeResponse` is schema-sampled offline while its live Bedrock call remains excluded. Latest deterministic baseline is 313 cases: 21 accepted, 292 rejected, 0 unexpected outcomes. Full repository suite: 130 passed.
...
- Last checkpoint commit: `62d512d` (`Classify non-object JSON as serialization failure`)
