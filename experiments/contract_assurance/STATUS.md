...
- Last checkpoint: `7626acc` (`Refresh reports with failure rate statistics`); current cycle adds qualified blind failure-code distributions to JSON/Markdown reports.
