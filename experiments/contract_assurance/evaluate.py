...
def _validation_code(exc: ValidationError) -> FailureCode:
    ...
    if any("requires" in message or "must belong" in message or "only valid" in message or "cannot contain" in message or "Substantive text" in message for message in messages):
