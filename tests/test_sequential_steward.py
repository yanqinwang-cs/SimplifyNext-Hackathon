...
from experiments.steward_screen.sequential import MultipleValidCase, first_move_is_acceptable, multiple_valid_cases, run_trajectory, summarize_trajectories
...
def test_multiple_valid_case_accepts_any_declared_legal_first_move() -> None:
    ...
    assert multiple_valid_cases()[0].acceptable_operations == frozenset({"archive", "reactivate"})
